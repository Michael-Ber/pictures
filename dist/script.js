...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_carousel__WEBPACK_IMPORTED_MODULE_0__["default"])('.main-slider', '.main-slider-item');
...
var carousel = function carousel(sliderSelector, itemSelector) {
  var sliderWrapper = document.querySelector(sliderSelector),
      sliderItem = document.querySelectorAll(itemSelector),
      height = sliderItem[0].clientHeight,
      up = document.querySelector('#up'),
      down = document.querySelector('#down');
  var offset = (sliderItem.length - 1) * height;
  var timerId = setInterval(moveSlides, 5000);
  sliderWrapper.style.height = "".concat(height, "px");
...
var form = function form(formSelector) {
  var forms = document.querySelectorAll(formSelector);
  forms.forEach(function (form) {
    var formData = new FormData(form);
    Object(_services_postData__WEBPACK_IMPORTED_MODULE_1__["default"])("../../../assets/server.php", formData).then(function (data) {
